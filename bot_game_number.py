...
BOT_TOKEN: str = env('BOT_TOKEN_GAME_NUMBER')
...
dp.register_message_handler(process_positive_answer,
                            Text(equals=['Да', 'Давай', 'Сыграем', 'Игра', 'Играть', 'Хочу играть'], ignore_case=True))
